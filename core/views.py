...
def homePage(request):
    lat, lon = 33.65097042297, 35.856345605529
    ...
    if not weather:
        ...
        cache.set(cache_key, weather, timeout=14400)  # cache for 10 minutes
    ...
    if not ai_suggestion:
        try:
            ...
            cache.set(ai_cache_key, ai_suggestion, timeout=21600)  # 6 hours
        except Exception as e:
            ai_suggestion = f"Could not get AI recommendations: {str(e)}"
